...
if (isset($_POST['user_update'])) {
    ...
    $user_image_tmp = $_FILES['user_image']['tmp_name']; // corrected typo: 'tmp' to 'tmp_name'
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 okay">
        ...
        <input type="submit" value="Update" name="user_update"  class="btn btn-green" >
                                </div>
    </form>
</body>
</html>